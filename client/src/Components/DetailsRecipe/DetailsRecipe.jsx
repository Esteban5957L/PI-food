            ...
            <div className={styles.contDetailOne}>
                ...
                <div className={styles.contDetailInfoPadre}>
                    <div className={styles.contDetailInfo}>
                        ...
                        <br />
                        <h3><span>Dish Type:</span> </h3>
                        <p className={styles.p1}>{myRecipe.dishTypes?.map( r => (<li className={styles.li}>- {r.name} </li>))}</p>
                        <br />
                        <h3><span>Diet Type:</span> </h3>
                        <p className={styles.p1}>{myRecipe.diets?.map(r => (<li className={styles.li}>- {r.name} </li>))}</p>
                        <br />
                        <h4><span>Servings:</span> {myRecipe.servings}</h4>
                        <h4><span>Spoonacular Score:</span> {myRecipe.spoonacularScore}</h4>
                        <h4><span>Health Score:</span> {myRecipe.healthScore}</h4>
                        <h4><span>minutes:</span> {myRecipe.readyInMinutes}</h4>
                    </div>
                </div>    
            </div>
            <br />
